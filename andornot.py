...
1.Если температура ниже 10 градусов ИЛИ идёт дождь и температура не выше 25 градусов, 
то предлагаем надеть что-то тёплое и взять зонт.

2.Если температура от 10 до 25 градусов И не идёт дождь и нет ветра, 
то предлагаем надеть куртку и кроссовки.
...
Сложновато? Не без этого: в столь длинных условиях легко запутаться даже опытному программисту. 
Давай упростим этот код, введя новые переменные для обозначения теплоты:
