...
Нормативы строгие: рост должен быть выше 90 см, а вес не более или равен 80 кг. 
При этом гномов и гномих с впечатляющей бородой длиной от 120 см берут сразу в VIP-отдел — такие данные встречаются у единиц.
...
По описанию она должна определить, проходит ли существо в модельное агентство и попадает ли в VIP-отдел. 
На экране должен появиться один из трёх вариантов: «проходит», «VIP» или «не проходит». 
